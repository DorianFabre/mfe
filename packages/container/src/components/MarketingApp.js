...
export default () => {
  ...
  useEffect(() => { // runs when this component is first accessed
    mount(ref.current); // creates an instance of the Marketing component using the mount() function...
    // ...and renders it into the div below
  });

  return <div ref={ref} />; // provides a reference to an element that is to be displayed on-screen
};