...
const mount = (el, { onNavigate, defaultHistory }) => {  // this function's name could be anything; el is the container for the content...
// ...onNavigate is a callback function passed in from the host (container) app which is called whenever a navigation event occurs in this remote (child) app...
// ...defaultHistory is used instead when this app is browsed in isolation

  const history = defaultHistory || createMemoryHistory(); // creates a history object to pass to the App component...
